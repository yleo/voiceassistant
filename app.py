...
def get_conference_data(info_type='information_confs'):
    """Oobtenir une brève description de la conférence ou des informations sur le déroulement, les intervenants des différentes conférences en fonction de l'argument info_type.
